  ...
  return (
    <footer className="footer-redesign">
      ...
      <div className="container">
        ...
        <div className="footer-redesign__grid">
          ...
          <div className="footer-redesign__col-brand">
            ...
            <div className="footer-redesign__socials">
              <a href="#" className="footer-redesign__social-btn" aria-label="LinkedIn">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.779-1.75-1.75s.784-1.75 1.75-1.75 1.75.779 1.75 1.75-.784 1.75-1.75 1.75zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                </svg>
              </a>
              <a href="#" className="footer-redesign__social-btn" aria-label="Facebook">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                </svg>
              </a>
              <a href="#" className="footer-redesign__social-btn" aria-label="Instagram">
              ...
              <a href="#" className="footer-redesign__social-btn" aria-label="Twitter">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
        ...
        {/* Widgets Row: Map and Calendly Contact Card */}
        <div className="footer-redesign__widgets">
          <div className="footer-map-card">
            {/* Embedded Istanbul Map Iframe */}
            <iframe
          ...
          <div className="footer-talk-card">
            <h4>Ready to Talk?</h4>
            <p>Book a free 15-minute 1-on-1 counseling session with our lead advisor on Calendly.</p>
            <a
              href="https://calendly.com"
              target="_blank"
              rel="noopener noreferrer"
              className="btn btn--orange"
              style={{ textAlign: 'center', fontSize: '0.8rem', padding: '10px 20px' }}
            >
