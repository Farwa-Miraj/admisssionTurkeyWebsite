    ...
    <section id="contact" className="cta-banner">
      <div className="container">
        <AnimatedSection className="cta-banner__card">
          <h2 className="cta-banner__title">Your future starts with a single message.</h2>
          <p className="cta-banner__desc">
            Tell us your background, your academic budget, and your dream goals, and we'll send back a personalized Turkish university shortlist within 24 hours.
          </p>
